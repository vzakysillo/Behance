    ...
    <main className="min-h-svh w-[min(100vw,1920px)] mx-auto grid grid-cols-[minmax(420px,49.74%)_minmax(460px,1fr)] overflow-hidden bg-white text-[#525252] font-['Inter',system-ui,sans-serif] text-left
      ...
      >
        ...
        >
          {/* Arrow icon */}
          <span
            className="w-2 h-4 border-l-2 border-b-2 border-current rotate-45"
            aria-hidden="true"
          />
          <span>Back</span>
        </Link>
      ...
      >
        <div className="mb-[45px] max-[560px]:mb-9">
          <h1
            id="login-title"
            className="mt-0 mb-[25px] text-[#525252] text-[50px] font-bold leading-[1.2]
                       max-[1024px]:text-[clamp(34px,8vw,50px)] max-[560px]:mb-[18px]"
          >
            Welcome Home!
          </h1>
